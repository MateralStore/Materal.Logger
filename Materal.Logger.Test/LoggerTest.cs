...
namespace Materal.Logger.Test
{
    ...
    public partial class LoggerTest
    {
        ...
        /// <returns></returns>
        [TestMethod]
        public async Task CustomDataTestAsync() => await WriteLogAsync(option =>
        {
        ...
        {
            const string connectionString = "Data Source=127.0.0.1;Database=Logs; User ID=sa; Password=Materal@123456;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=True;";
        ...
        {
            const string connectionString = "Server=127.0.0.1;Port=3306;Database=Logs;Uid=root;Pwd=Materal@123456;AllowLoadLocalInfile=true;";
        ...
        {
            const string connectionString = "user id=MATERAL; Password=Materal@123456; data source=(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST =127.0.0.1)(PORT = 1521))(CONNECT_DATA =(SERVER = DEDICATED)(SERVICE_NAME = FREEPDB1)));VALIDATE CONNECTION=True;";
        ...
        public async Task WriteMongoLogTestAsync() => await WriteLogAsync(option =>
        {
            ...
            option.AddMongoTarget("MongoLogger", connectionString, "Logs", "${Level}Log");
        });
        /// <summary>
        /// 写WebSocket日志
        /// </summary>
